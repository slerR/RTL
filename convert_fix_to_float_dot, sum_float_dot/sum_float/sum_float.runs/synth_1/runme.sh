...
HD_PWD='C:/Xilinx/Vivado/CUM_LAB/lab_9/sum_float/sum_float.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_adder.tcl
