...
HD_PWD='C:/Xilinx/Vivado/CUM_LAB/lab_8/cod_7_5/cod_7_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab81.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab81.tcl
