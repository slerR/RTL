...
HD_PWD='C:/Xilinx/Vivado/CUM_LAB/lab_11/delay/delay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_with_srst.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_with_srst.tcl
