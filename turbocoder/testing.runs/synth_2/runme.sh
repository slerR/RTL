...
HD_PWD='C:/Xilinx/Vivado/CUM_LAB/testing/testing.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log turbocoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source turbocoder.tcl
