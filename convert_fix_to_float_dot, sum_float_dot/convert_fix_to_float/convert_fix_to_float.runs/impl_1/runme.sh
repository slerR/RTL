...
HD_PWD='C:/Xilinx/Vivado/CUM_LAB/lab_10/convert_fix_to_float/convert_fix_to_float.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fixed_to_float.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fixed_to_float.tcl -notrace
